...
public class UserDaoImpl implements UserDao{
	...
	private static final String SQL_INSERT = "INSERT INTO user (email, password, name, admin, news) VALUES (?, ?, ?, ?, ?)";
	...
	public void create(UserBean user) throws IllegalArgumentException, DaoException {
		...
		try {
			connection = daoFactory.getConnection();
			statement = DaoUtils.initStatement(connection, SQL_INSERT, true, user.getEmail(), user.getPassword(), user.getName(), user.getAdmin(), user.getNews());
